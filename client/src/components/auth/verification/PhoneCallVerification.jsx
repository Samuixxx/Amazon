...
const PhoneCallVerificationForm = () => {
        ...
        const initializeVerification = async () => {
            try {
                ...
                if (xsrfOk) {
                    ...
                    try {
                        const otpResponse = await api.post("/auth/signup/getOtpToCall",
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const verifyCodeRequest = await api.post("auth/signup/verifyCallOtp", { code: code, clientId: userClientId }, {
                headers: {
    ...
    return (
        <form className="verification-form" onSubmit={handleSubmit}>
            ...
            <h3 className="verification-form-subtitle">
                {t("Phone call Verification")}
            </h3>
            <span className="verification-form-description">
                {t("We'll communicate a One-Time Password (OTP) to:")} <strong>{formData.prefix + formData.telephone}.</strong>
...
export default PhoneCallVerificationForm